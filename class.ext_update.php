...
class ext_update {
	...
	protected $notificationRules = array (
		...
		array (12, 'ich in %s einen Teens-Treff-Einsatz habe', 'In %1$s, am %2$s, habe ich einen Teens-Treff-Einsatz.', 0, 1, 0),
		array (13, 'ich in %s einen Kids-Treff-Einsatz habe', 'In %1$s, am %2$s, habe ich einen Kids-Treff-Einsatz. Das Thema ist "%6$s".', 0, 1, 0),
		...
		array (22, 'die Planung eines Teens Treffs, in den ich involviert bin, verändert wurde', 'Im Teens Treff vom %1$s hat %2$s die Angabe %3$s von "%4$s" zu "%5$s" verändert.', 1, 1, 1),
		array (23, 'die Planung eines Kids Treffs, in den ich involviert bin, verändert wurde', 'Im Kids Treff vom %1$s hat %2$s die Angabe %3$s von "%4$s" zu "%5$s" verändert.', 1, 1, 1),
