...
class TrackingRepository extends \TYPO3\CMS\Extbase\Persistence\Repository {
	...
	* @return
	*/
	public function findByMaster (\FKU\FkuPlanning\Domain\Model\Master $master) {
		$orderings = array ('moment' => \TYPO3\CMS\Extbase\Persistence\QueryInterface::ORDER_DESCENDING);
		$query = $this->createQuery();
		$query->matching($query->equals('master',$master));
